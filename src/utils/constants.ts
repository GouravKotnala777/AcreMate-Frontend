...
export const PRIMARY_FADE = "#c5ffec87";
export const PRIMARY_LIGHTER = "#e0fff5";
...
export const l = "0.9rem";
export const med = "0.8rem";
export const s = "0.7rem";
export const xs = "0.65rem";